        ...
        <div className="profile">
          <div className="profile__header">
            <div className="profile__header__picture">
              <img
                src={stamp}
                className="profile__header__picture__border"
                alt=""
              />
              <img
                src={userIdData.profilePicture}
                className="profile__header__picture__image"
                alt=""
              />
            </div>
            <div className="profile__header__infos">
              <div className="profile__header__infos__name">
                {userIdData.firstName} {userIdData.lastName}
              </div>
              <div className="profile__header__infos__email">
                {userIdData.email}
              </div>
            </div>
          </div>
          <div className="profile__content">
            ...
            <div className="profile__content__modify">
              <ModifyButtons
                ...
                editHandleClick={handleEditUser}
                deleteHandleClick={handleDeleteUser}
              />
            </div>
          </div>
        </div>
        ...
        <form className="profile" onSubmit={handleConfirm}>
          <div className="profile__header">
            <div className="profile__header__picture">
              ...
              />
              <FormField
                className="profile__header__picture__choice"
                type="file"
                name="profilePicture"
            ...
            <div className="profile__header__infos">
              <FormField
                className="profile__header__form__firstName"
                name="newFirstName"
                type="text"
                defaultValue={userIdData.firstName}
                children="Firstname"
              ...
              <FormField
                ...
                name="newLastName"
                type="text"
                defaultValue={userIdData.lastName}
                children="Lastname"
                onChange={handleChange}
              />
              <div className="profile__header__form__email">
                <FormField
                  className="profile__header__form__email"
                  name="newEmail"
                  type="email"
